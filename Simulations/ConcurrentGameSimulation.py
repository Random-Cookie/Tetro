...
PLAYERS = [StaticHeatmapPlayer('blue', INITIAL_PIECES[0], BOARD_SIZE, 'Players/heatmaps/aggressiveX.txt'),
    ...
    StaticHeatmapPlayer('red', INITIAL_PIECES[2], BOARD_SIZE, 'Players/heatmaps/reverse_bullseye.txt'),
    StaticHeatmapPlayer('yellow', INITIAL_PIECES[3], BOARD_SIZE, 'Players/heatmaps/reverse_bullseye.txt')]
